  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <h2 className="mt-4 font-serif text-2xl text-foreground">Crumbs, page not found</h2>
        <p className="mt-2 text-sm text-muted-foreground">
          The page you're looking for got eaten. Let's get you back to the cookies.
        </p>
        <div className="mt-6">
          <Link
            to="/"
  ...
  head: () => ({
    meta: [
      ...
      { title: "Jigsaw Cookies — Small-batch cookies, delivered warm" },
      {
        name: "description",
        content:
          "Hand-broken chocolate, brown-butter dough, baked the morning they ship. Order Jigsaw Cookies for delivery nationwide.",
      },
      { name: "author", content: "Jigsaw Cookies Co." },
      { property: "og:title", content: "Jigsaw Cookies" },
      {
        property: "og:description",
        content:
          "Small-batch cookies baked the morning they ship. Delivered nationwide.",
      },
